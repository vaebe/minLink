...
export default async function Home() {
  ...
  return (
    <main className="flex flex-col min-h-screen bg-background text-foreground overflow-x-hidden selection:bg-orange-apple/20 selection:text-orange-apple">
      
      {/* Hero Section with Form */}
      <HomeHero isAuthenticated={Boolean(user)} />

      {/* Feature Section - Minimal Apple Style */}
        ...
        <div className="container mx-auto max-w-6xl">
           <div className="grid grid-cols-1 md:grid-cols-3 gap-16 md:gap-12">
              ...
              <div className="flex flex-col gap-6 items-start group">
                 <div className="w-14 h-14 rounded-2xl bg-secondary flex items-center justify-center group-hover:bg-orange-apple/10 transition-colors duration-500">
                    <Zap className="w-7 h-7 text-foreground group-hover:text-orange-apple transition-colors duration-500" />
                 </div>
              ...
              <div className="flex flex-col gap-6 items-start group">
                 <div className="w-14 h-14 rounded-2xl bg-secondary flex items-center justify-center group-hover:bg-orange-apple/10 transition-colors duration-500">
                    <BarChart3 className="w-7 h-7 text-foreground group-hover:text-orange-apple transition-colors duration-500" />
                 </div>
                 <div className="space-y-3">
              ...
              <div className="flex flex-col gap-6 items-start group">
                 <div className="w-14 h-14 rounded-2xl bg-secondary flex items-center justify-center group-hover:bg-orange-apple/10 transition-colors duration-500">
                    <Shield className="w-7 h-7 text-foreground group-hover:text-orange-apple transition-colors duration-500" />
                 </div>
                 <div className="space-y-3">
